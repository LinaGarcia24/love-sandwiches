...
def update_worksheet(data, worksheet):
    """
    Updates selected worksheet, adds new row with list of data provided.
    """
...
def calculate_surplus_data(sales_row):
    ...
    - Negative surplus indicates extra was made when stock was sold out.
    """
...
def calculate_stock_data(data):
    """
    Calculare the average stock for each item type, adding 10%.
    """
